...
\begin{proof} Introduce
    ...
    \begin{description}
        ...
        \begin{enumerate}
            ...
            \item[4.] If $m\ne m'$, then \ref{TR4} there exists a unique pair $(x,y)$ incident with both $[m,b]$ and $[m',b']$. If $m=m'$ and $b\ne b'$, the two lines intersect at $(\infty)$.  
...
\begin{proof}
    ...
    On the other hand, given $x\in\ter$, by \ref{TR1}, we have
    \begin{align*}
        T'(1',\theta(x),0') &= \theta(x)\\
            &= \theta(T(1,x,0))\\
            &= T'(\theta(1),\theta(x),0')
...
\begin{proof}
    ...
    The equations $a\+0=a$ and $0\+a=a$ are equivalent to $T(a,1,0)=a$ and $T(0,1,a)=a$, which hold by \ref{TR1}.
    ...
    The equations $a\cdot1=a$ and $1\cdot a=a$ are equivalent to $T(a,1,0)=a$ and $T(1,a,0)=a$, which hold by \ref{TR1}.
\end{proof}
...
\begin{proof} Suppose that $\Pi$ is $(X,XY)$-transitivie. Fix $a,b,c\in\ter$. Let $A\colon(a,0)$, $B\colon(b,0)$, and $C\colon(0,c)$. Locate the points $Q'$, $Q$, $P'$, $P$, $R$, $R'$, $S$, and $S'$, as defined below
    $$
        ...
        \begin{align*}
            ...
            Q\phantom'&\colon(0,b)\\
            P'&\colon(b,b\+c)\\
            P\phantom'&\colon(0,b\+c)\\
            R\phantom'&\colon(a,a\+b)\\
            R'&\colon(a\+b,a\+b)\\
            S\phantom'&\colon(a,a\+(b\+c))\\
            S'&\colon(a\+b,(a\+b)\+c)\\
        \end{align*}
        }
        \end{minipage}
