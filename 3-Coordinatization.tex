...
\begin{proof}
    $$
        ...
        \begin{tikzpicture}[
            ...
            \coordinate (ystart) at (0.0,0.0);
            \coordinate (yend) at (0.0,2*\s);
            \coordinate (Ax) at (\s*0.55,\s*0.0);
            \coordinate (B) at (0.0,\s*0.5);
            \coordinate (C) at (0.0,\s*1.0);
            \coordinate (P) at (0.0,\s*1.4);
            \coordinate (E) at (\s*1.8,\s*0.8);
            ...
            \draw[name path=ZP] (Z) -- (P);
            \draw[name path=AxY] (Ax) -- (Y);

            %Intersections
            \draw[name path=BX] (B) -- (X);
            \path[name intersections={of=OE and BX,by=Q'}];
            \path[name path=BY1] (Y) -- ($(Y)!1.37!(Q')$);
            \path[name intersections={of=xaxis and BY1,by=Bx}];
            \draw[name path=BY] (Y) -- (Bx);
            \path[name intersections={of=AxY and ZB,by=R}];
            \path[name intersections={of=BX and BY1,by=Q'}];
            ...
            \node[point,
                fill=green,
                label={[xshift=-3mm,yshift=-3mm,text=black]:
                    $P$}
            ] at (P) {};
            \node[point,
                fill=green,
                label={[xshift=0mm,yshift=-6mm,text=black]:
                    $(a,0)$}
            ] at (Ax) {};
            \node[point,
                fill=green,
                label={[xshift=1mm,yshift=-0.5mm,text=black]:
                    $Q'$}
            ] at (Q') {};
            \node[point,
                fill=green,
                label={[xshift=0.5mm,yshift=-6mm,text=black]:
                    $(b,0)$}
            ] at (Bx) {};
            \node[point,
                fill=green,
                label={[xshift=-2.3mm,yshift=-1.5mm,text=black]:
                    $R$}
            ] at (R) {};
        \end{tikzpicture}
        \end{minipage}
